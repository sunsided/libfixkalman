...
libfixkalman relies on [libfixmath](https://code.google.com/p/libfixmath/) and [libfixmatrix](https://github.com/PetteriAimonen/libfixmatrix) for all calculations.
...
For each of these types a separate set of functions exists: Regular functions and functions postfixed with `_uc` (such as [kalman_predict_uc](#kalman_predict_uc)) for uncontrolled systems.
...
This function is a thin wrapper around [kalman_predict_x](#kalman_predict_x) and [kalman_predict_P](#kalman_predict_p).
It is often more efficient to perform the state update manually instead of relying on the matrix multiplication algorithm. In this case, [kalman_predict_P](#kalman_predict_p) can be used to update the system covariance
matrix afterwards.
...
Similar to *kalman_predict()*, this function is a thin wrapper around [kalman_predict_x](#kalman_predict_x) and [kalman_predict_P_tuned](#kalman_predict_p_tuned).
It is often more efficient to perform the state update manually instead of relying on the matrix multiplication algorithm. In this case, [kalman_predict_P_tuned](#kalman_predict_p_tuned) can be used to update the system covariance
matrix afterwards.
...
In cases where it is more efficient to calculate the state update manually (i.e. by not calling [kalman_predict](#kalman_predict)), *kalman_predict_P* can be used to update the covariance matrix.
...
In cases where it is more efficient to calculate the state update manually (i.e. by not calling [kalman_predict_tuned](#kalman_predict_tuned)), *kalman_predict_P_tuned* can be used to update the covariance matrix.
...
This function is a thin wrapper around [kalman_predict_x_uc](#kalman_predict_x_uc) and [kalman_predict_P_uc](#kalman_predict_p_uc).
It is often more efficient to perform the state update manually instead of relying on the matrix multiplication algorithm. In this case, [kalman_predict_P_uc](#kalman_predict_p_uc) can be used to update the system covariance
matrix afterwards.
...
This function is a thin wrapper around [kalman_cpredict_x_uc](#kalman_cpredict_x_uc) and [kalman_cpredict_P_uc](#kalman_cpredict_p_uc).
It is often more efficient to perform the state update manually instead of relying on the matrix multiplication algorithm. In this case, [kalman_cpredict_P_uc](#kalman_cpredict_p_uc) can be used to update the system covariance
matrix afterwards.
...
Similar to *kalman_predict_uc()*, this function is a thin wrapper around [kalman_predict_x_uc](#kalman_predict_x_uc) and [kalman_predict_P_tuned_uc](#kalman_predict_p_tuned_uc).
It is often more efficient to perform the state update manually instead of relying on the matrix multiplication algorithm. In this case, [kalman_predict_P_tuned_uc](#kalman_predict_p_tuned_uc) can be used to update the system covariance
matrix afterwards.
...
In cases where it is more efficient to calculate the state update manually (i.e. by not calling [kalman_predict_tuned_uc](#kalman_predict_tuned_uc)), *kalman_predict_P_tuned_uc* can be used to update the covariance matrix.
